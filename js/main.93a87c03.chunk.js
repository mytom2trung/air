(this["webpackJsonpair-conditioner"] = this["webpackJsonpair-conditioner"] || []).push([
	[0], {
		...
		113: function(e, t, r) {
			...
			function w() {
				...
				return Object(u.jsxs)(g.a, {
					...
					className: e.root,
					color: "textSecondary",
					children: [Object(u.jsx)(O.a, {}), "Tip: Mang đến sự tiện nghi cho gia đình bạn！"]
				})
			}
			var y = r(33),
				k = r(140),
			...
			var ue = Object(l.a)({
				...
				de = ae("/media/audio/di.mp3"),
				je = ae("/media/audio/ac-work.mp3"),
				be = ae("/media/audio/air-extractor-fan.mp3");
			...
			function he() {
				...
				return Object(u.jsxs)(f.a, {
					...
					children: [Object(u.jsx)("audio", {
						...
						onClick: function() {
							r((function(e, t) {
								z(t()) < 31 ? e(X()) : (e(V("Đó là nhiệt độ tối đa！")), e(_(!0)))
							}))
						},
						...
						onClick: function() {
							r((function(e, t) {
								z(t()) > 16 ? e(Z()) : (e(V("Đó là nhiệt độ tối thiểu！")), e(_(!0)))
							}))
						},
			...
			var me = r(15),
				ge = r(146),
				fe = r(141),
				xe = "static/media/logo.5fb28574.svg",
				pe = r(38),
				Oe = (r(110), "#e0e0e0"),
				ve = "#cccccc",
				we = "#bbbbbb",
					...
					children: Object(u.jsxs)(j.a, {
						...
						children: [Object(u.jsxs)(f.a, {
							...
							children: [Object(u.jsx)(g.a, {
								...
								component: "h1",
								gutterBottom: !0,
								children: "Điều Hoà Không Khí Online"
		...
		38: function(e) {
			e.exports = JSON.parse('{"b":"Air conditioners","a":{"url":"#","email":"pnmop2001@gmail.com","name":"Itachi"},"c":{"type":"git","url":"#"}}')
		}
	},
	[
		[113, 1, 2]
